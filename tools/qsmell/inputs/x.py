...
epair4 = QuantumRegister(num_fly_qubits, name='epair4')
...
def main(qck):
    ...
    flykk = epair1
    prepare_fly(fly)
    epair3 = QuantumRegister(num_fly_qubits, name='epair3')
    qc2 = QuantumCircuit(fly, epair1, epair3, *send0_c, *send1_c)
    qce = qck
    qce.barrier()
    if do_teleport:
        entangle_pair(flykk, epair2)
