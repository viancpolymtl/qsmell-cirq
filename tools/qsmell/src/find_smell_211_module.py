...
def find_smell_211(my_parsed_object, my_circuit_bit_object, call_order_line_list):
    ...
    exclude_barrier_circuit_call_list = filter_circuit_call_list(result_list)
    print("exclude barrier list = ", exclude_barrier_circuit_call_list)
    customized_gate_list = filter_non_customized_gate(exclude_barrier_circuit_call_list)
    return customized_gate_list